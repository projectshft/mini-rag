...
export async function POST(request: NextRequest) {
	...
	// 5. Generate embeddings using openai.embeddings.create()
	//    - Model: 'text-embedding-3-small', Dimensions: 1536
	// 6. Prepare vectors for Weaviate: { id, values, metadata: { text, source, ... } }
	// 7. Upload vectors to Weaviate using insertDocuments()
